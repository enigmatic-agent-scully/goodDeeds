                  ...
                  {this.props.resolved ? (
                    <div>
                      <Button
                        ...
                        onClick={() =>
                          this.props.markUnresolved(this.props._id)
                        }
                      >
                        Mark Unresolved
                      </Button>
                ...
                {this.props.resolved ? (
                  ...
                  <div>
                    <Button
                      ...
                      onClick={() => this.props.markResolved(this.props._id)}
                    >
>>>>>>> c631443669e5951a623ac274cec622b291bdc695
                        Mark Resolved
                      </Button>
                      <Button
                        className='delete-button'
                      ...
                      {this.props.goodSamaritins.map(helper => (
                        <Chip>
                          <img
                            src='https://gooddeedsimages.s3.amazonaws.com/goodsamaritin.PNG'
                            alt='good samaritin badge'
                          />
                          {helper.userName}
                        </Chip>
                      ))}
                ...
                <div>
                  {this.props.goodSamaritins.find(
                    currentGoodSamaritin =>
                      currentGoodSamaritin.id === this.props.currentUserID
                  ) ? (
                    <Button id='offer-help-button' disabled>
                    ...
                    <Button
                      id='offer-help-button'
                      onClick={() => this.props.offerHelp(this.props._id)}
                    >
                      Offer Help
                    </Button>
<<<<<<< HEAD
                  ...
                  <Chip className='chip'>
                    <img
                      className='needusericon'
                      src={this.props.needUser.imageurl}
                      alt={this.props.needUser.userName}
                    />
                    <strong>
                      Need posted by {this.props.needUser.userName}
                    </strong>{' '}
                    @<small>{this.props.postdate}</small>
                  </Chip>
                </div>
              )}
            </Row>
